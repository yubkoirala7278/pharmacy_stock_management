$(function () {
	...
	// chart 8
	var options = {
		series: [33.33, 25.00, 22.5, 25],
		chart: {
			foreColor: '#9ba7b2',
			height: 330,
			type: 'pie',
		},
		colors: ["#4d8be7", "#212529", "#55a94f", "#e38f3e"],
		labels: ['Sales', 'Administration', 'Technical', 'HR'],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
	...
	var options = {
		...
		colors: ["#4d8be7", "#212529", "#55a94f", "#d73a3a", "#e38f3e"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
